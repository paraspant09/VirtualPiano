<?php
    ...
    $publicTracks = fetchUserPublicTracks($artist_username);
    $privateTracks = fetchUserPrivateTracks($artist_username);
...
<html lang="en" dir="ltr">
    ...
    <body style="overflow:hidden">
        ...
        <div id="restbody">
            ...
            <div class="flex-row">
                <div class="flex-col" style="width:40%; height:300px">
                    <div class="card highlights">
                            <div class="card-title highlights-title">
                                <h2 style="color:antiquewhite">Public Tracks</h2>
                                <div class="underline-title"></div>
                            </div>
                            
                            <?php
                                if(isset($publicTracks)){
                                    if(sizeof($publicTracks) == 0)
                ...
                <div class="flex-col" style="width:40%; height:300px">
                    <div class="card highlights">
                            <div class="card-title highlights-title">
                                <h2 style="color:antiquewhite">Private Tracks</h2>
                                <div class="underline-title"></div>
                            </div>
                            
                            <?php
                                if(isset($privateTracks)){
                                    if(sizeof($privateTracks) == 0)
                                        echo "<p>No tracks made by this user</p>";
                                    else{
                                        echo "<div class='highlights-list-header'>";
                                        ...
                                        echo "</div>";
                                        echo "<div class='scrollable-list'>";
                                        foreach($privateTracks as $track){
                                            $trackName = $track['name'];
                                            $creat_time = strtotime($track['creation_date']);
                                            $creatDate = date('d-m-Y',$creat_time);
                                            echo "<button type='button' class='highlights-list-item' onclick=\"fetchAndPlaySong('$artist_username', '$trackName')\">";
